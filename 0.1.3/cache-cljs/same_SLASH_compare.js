...
same.compare.near_zero_double = (function same$compare$near_zero_double(f,max_diff){
return (f <= same.platform.ulp.call(null,max_diff));
});
/**
 * Test if a number is near zero.
 */
same.compare.near_zero = (function same$compare$near_zero(f,max_diff){
return same.compare.near_zero_double.call(null,f,max_diff);
});
 ...
 */
same.compare.compare_ulp = (function same$compare$compare_ulp(max_diff,max_ulp){
var max_abs = same.platform.ulp.call(null,max_diff);
